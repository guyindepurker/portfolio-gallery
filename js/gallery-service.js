...
function createProjects(){
    ...
    projects.push(createProject('touch-the-nums','Touch The Nums','Touch The Nums - Game','The User need to touch the first num is 1 and after ascending order '))
    ...
    projects.push(createProject('guessMe','GuessMe','Think about someone and i guess','Cool game that the computer guess your choice'))
